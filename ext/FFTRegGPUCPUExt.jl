...
import FFTRegGPU: _ifft!, _plan_fft_inplace, _fft_inplace!

_fft(inp::StridedArray) = FFTW.fft(inp)
_ifft(inp::StridedArray) = FFTW.ifft(inp)
_ifft!(inp::StridedArray{<:Complex}) = FFTW.ifft!(inp)
_plan_fft_inplace(inp::StridedArray{<:Complex}) = FFTW.plan_fft!(inp)
_fft_inplace!(inp::StridedArray{<:Complex}) = FFTW.fft!(inp)
_fft_inplace!(inp::StridedArray{<:Complex}, plan::FFTW.cFFTWPlan) = (plan * inp)
